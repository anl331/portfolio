  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col-reverse pl-5 ">
        <h3 className="uppercase tracking-[16px] text-gray-500 text-2xl">Skills</h3>
      </div>

      <div className="relative flex flex-col justify-center items-center flex-grow w-screen">
        <h3 className="text-xs md:text-sm lg:text-lg uppercase pb-10 tracking-[1px] md:tracking-[3px] text-gray-500">Hover over a skill for current proficiency.</h3>
