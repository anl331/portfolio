        ...
        {sortedPorjects?.map((project, i) => (
          <div className=" relative w-screen flex-shrink-0 snap-center snap-always flex flex-col space-y-5 items-center justify-center px-6" key={i}>
            ...
            <div className="max-w-3xl space-y-4">
              ...
              <a className="flex projectButton justify-center items-center group backdrop-blur-sm" target="_blank" href={project.linkToBuild}>
                <p className=" mt-2">View Github Repo</p>
                <svg className="relative top-[3px] ml-1 fill-gray-500 group-hover:fill-yellow-500 transition-all duration-150" width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
